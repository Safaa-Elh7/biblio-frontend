...
<body>
    ...
    <div class="ml-14 p-4">
        ...
        <header class="header">
            ...
            <div class="flex items-center">
                <div class="search-container mr-4">
                    ...
                    <input type="text" id="searchInput" placeholder="Find your next favorite book..." class="search-input">
                </div>
        ...
        <div class="categories-container scrollbar-hide">
            <div class="category-item" style="background-color: #7c2d2d; color: white; border-radius: 0.5rem; padding: 0.5rem;">
        ...
        <div class="banner mb-12">
            <img src="https://images.unsplash.com/photo-1474366521946-c3d4b507abf2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80" alt="Best of Today" class="banner-image">
            <div class="banner-overlay">
                <div class="banner-content">
                    <h2 class="banner-title">BEST OF TODAY</h2>
                    <p class="banner-text">
                        Explore the literary highlights of 2023 with our '50 Most Popular Bestsellers' badge—a curated collection of the year's must-reads.
                    </p>
